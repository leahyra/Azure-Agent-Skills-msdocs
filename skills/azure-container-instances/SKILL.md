...
| Limits & Quotas | L61-L69 | ACI limits on CPU/memory, quotas by region, standby pool constraints, behavior FAQs, and networking/VNet considerations that affect container capacity and availability |
