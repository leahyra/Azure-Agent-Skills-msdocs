...
|----------|-------|-------------|
| Troubleshooting | L29-L32 | Diagnosing and resolving Azure Analysis Services network connectivity issues, including firewall/VNet settings, gateways, client connection errors, and verification tools/logs. |
