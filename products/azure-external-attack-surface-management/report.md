...
category_descriptions:
  configuration: Configuring Defender EASM inventory filters (domains, hosts, IPs,
    ASNs, SSL, pages, contacts), understanding asset metadata, and wiring data/policy
    automation to Log Analytics/ADX.
  limits-quotas: Explains how Defender EASM counts billable assets, what qualifies
    as a billable asset, and how those counts impact licensing and costs.
skill_description: Expert knowledge for Azure External Attack Surface Management development
  including limits & quotas, and configuration. Use when tuning EASM inventory filters,
  interpreting asset metadata, automating exports to Log Analytics/ADX, or estimating
  billable assets, and other Azure External Attack Surface Management related development
...
use_when: Use when tuning EASM inventory filters, interpreting asset metadata, automating
  exports to Log Analytics/ADX, or estimating billable assets, and other Azure External
  Attack Surface Management related development tasks.
...
| [SSL certificate asset filters](https://learn.microsoft.com/en-us/azure/external-attack-surface-management/ssl-certificate-asset-filters) | configuration | 0.90 | Reference for SSL certificate filters with operators and accepted value formats; detailed, product-specific configuration information. |
...
| [Understand asset details](https://learn.microsoft.com/en-us/azure/external-attack-surface-management/understanding-asset-details) | configuration | 0.70 | Asset details pages typically enumerate product-specific metadata fields (per asset type) and how they’re populated/used; this is configuration-style reference information that an LLM wouldn’t reliably infer from training. |
| [Understand billable assets](https://learn.microsoft.com/en-us/azure/external-attack-surface-management/understanding-billable-assets) | limits-quotas | 0.70 | Billing pages usually define what constitutes a billable asset, trial duration, and possibly thresholds; these are numeric/definition limits specific to the service and not generally known. |
...
| [Use and manage discovery](https://learn.microsoft.com/en-us/azure/external-attack-surface-management/using-and-managing-discovery) | 0.40 | Describes how Defender EASM discovery works conceptually; summary doesn’t suggest detailed config tables, limits, or error codes. |
...
| [Understand dashboards](https://learn.microsoft.com/en-us/azure/external-attack-surface-management/understanding-dashboards) | 0.20 | Dashboard overview/description; no indication of numeric limits, config tables, or error mappings—primarily conceptual UI guidance. |
